    ...
    <header className="fixed w-full top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="container mx-auto flex items-center justify-between h-16 px-4 md:px-6">
        <div className="flex items-center">
          <Link to="/" className="font-bold text-xl text-sport-blue-dark flex items-center gap-2">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <Link to="#tools" className="text-gray-700 hover:text-sport-blue transition-colors">
            Инструменты
          </Link>
          <Link to="#stats" className="text-gray-700 hover:text-sport-blue transition-colors">
            Статистика
          </Link>
          <Link to="#pricing" className="text-gray-700 hover:text-sport-blue transition-colors">
            Тарифы
          </Link>
